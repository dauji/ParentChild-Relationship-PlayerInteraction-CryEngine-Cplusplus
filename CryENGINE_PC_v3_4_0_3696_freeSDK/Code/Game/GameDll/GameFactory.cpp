...
#define REGISTER_VEHICLEOBJECT(name, obj) \
	...
	REGISTER_GAME_OBJECT(pFramework, Tractor, "");
	REGISTER_GAME_OBJECT(pFramework, Humvee, "");
	REGISTER_GAME_OBJECT(pFramework, TowingMechanism, "");
	...
	REGISTER_GAME_OBJECT(pFramework, MyTurret, "");

	//GameRules
	REGISTER_FACTORY(pFramework, "GameRules", CGameRules, false);

	//REGISTER_GAME_OBJECT_EXTENSION(pFramework, VehicleCarrier);
